...
public class Automovil extends Vehiculo{
    ...
    public Automovil(String placa, int puertas, int velocidadMaxima, String nombre, int precio, int peso, String traccion, Fabricante fabricante, int cantidadVehiculos, int puestos) {
